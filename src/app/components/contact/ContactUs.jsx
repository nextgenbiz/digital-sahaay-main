...
setErrors((prev) => ({ ...prev, submit: "Something went wrong. Please try again." }));  } finally {
  ...
  return (
    <>
      ...
      <div className="w-full z-10 flex items-center justify-center p-0 sm:p-6 transition-opacity">
        {/* Card Container */}
        <div className="bg-white  rounded-[30px] shadow-xs w-full max-w-[1180px] flex flex-col md:flex-row overflow-hidden relative">
              ...
              {!isSubmitted ? (
                <div className="space-y-3 mb-3 md:mb-8">
                  <h2 className="text-[24px] md:text-[44px] font-bold leading-tight tracking-tighter ">
                    Let's Grow Your <br />
                    <span className="text-[#FFE78A]">Business Smarter</span>t
                  </h2>
                  <p className="text-[#CFC8FF] text-[14px] md:text-[16px] w-72 md:w-75 leading-tight tracking-tighter ">
            ...
            {!isSubmitted ? (
              ...
              <div className="w-full max-w-2xl mx-auto">
                <div className="mb-2 md:mb-2">
                  ...
                  <p className="text-[12px] md:text-[16px] font-medium text-[#6A6A6A]/70">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                    ...
                    >
                      <input
                        ...
                        placeholder=" "
                        className={`block w-full px-0 pt-4 pb-2 font-semibold text-[16px] text-[#333333] bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer transition-colors ${errors.name ? "border-red-500" : formData.name ? "border-[#5B47E5]" : "border-gray-200 focus:border-[#5B47E5]"}`}
                      />
                      <label
                        htmlFor="name"
                    ...
                    >
                      <input
                        ...
                        onChange={handleChange}
                        placeholder=" "
                        className={`block w-full px-0 pt-4 pb-2 font-semibold text-[16px] text-[#333333] bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer transition-colors ${errors.company ? "border-red-500" : formData.company ? "border-[#5B47E5]" : "border-gray-200 focus:border-[#5B47E5]"}`}
                      />
                      <label
                        htmlFor="company"
                  ...
                  {/* Select Service */}
                  <div
                    className={`relative group mb-2 md:mb-6 pt-2 md:pt-2 ${errors.service && shake ? "animate-shake" : ""}`}
                  >
                    <label
                      htmlFor="service"
                      className={`hidden md:block text-[16px] font-semibold mb-2 ${errors.service ? "text-red-500" : "text-[#6A6A6A]"}`}
                    >
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        className={`block w-full px-0 md:px-2 pb-2 md:pb-2 pt-1 text-[16px] font-semibold text-[#333333] bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 cursor-pointer ${
                          errors.service
                            ? "border-red-500"
                            : formData.service
                              ? "border-[#5B47E5]"
                  ...
                  {/* Textarea */}
                  <div className="hidden md:block md:relative pt-1">
                    <label
                      htmlFor="projectDetails"
                      className="block text-[16px] font-semibold text-[#6A6A6A] mb-1"
                    >
                      Tell Us About Your Project
                    </label>
                    <p className="text-[12px] font-medium text-[#6A6A6A]/70 mb-0">
                    ...
                    <textarea
                      ...
                      rows="2"
                      placeholder=" "
                      className="block w-full px-0 py-2 text-[16px] font-semibold text-[#333333] bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-[#5B47E5] resize-none"
                    ></textarea>
              ...
              <div className="w-full h-full flex flex-col justify-center animate-fade-in-up">
                ...
                <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full text-[16px] font-semibold w-max mb-6">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                ...
                <div className="hidden md:grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
                  {/* Step 1 */}
                ...
                <div className="border-t border-gray-100 pt-6">
                  ...
                  <p className="text-[16px] text-[#604BE3] leading-tight tracking-tighter font-semibold">
